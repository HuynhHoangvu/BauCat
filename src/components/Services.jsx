      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="mb-14 reveal">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <h2 className="text-3xl sm:text-4xl font-black text-gray-900 uppercase tracking-tighter max-w-2xl [text-wrap:balance] text-center lg:text-left">
              <SplitText 
                text="Viết nên câu chuyện của riêng bạn" 
                delay={0.05} 
